...
/*
    console_log (join "loaded data is" (@vroot->loaded_data | get_param name="output"));
    @vroot->loaded_data | console_log text="rerere";
    @vroot->loaded_data | debugger;
*/    
  ...
  _dat: df_set input=@vroot->loaded_data {{ console_log_params }};

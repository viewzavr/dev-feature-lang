...
Таким образом, по существу, мы создадим новый формат описания "объектов". Это упрощенные объекты, получается. Они реагируют на любой свой параметр (кроме output). С учетом, что мы хотим двигать компаланг как замену js, это выглядит вполне возможным.

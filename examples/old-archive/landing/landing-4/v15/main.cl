...
load files="lib3dv3 csv params io gui render-params df scene-explorer-3d 12chairs.cl gui3.cl";
...
register_feature name="plashka" {
  style="background: rgba(99, 116, 137, 0.36);padding: 5px; min-width:220px;";
...
mainscreen: screen auto-activate {
  ...
  column style="" 
         padding="0.3em" margin="0.7em" gap="0.5em"
    {

    collapsible text="Данные" plashka {
      render-params object_path="@mainparams";
    };

    layers_gui3 layer={data_visual_layer} pattern="** data_visual_layer" text="Визуализация" plashka;

    layers_gui3 layer={static_visual_layer} pattern="** static_visual_layer" text="Прочие образы" plashka;

    layers_gui3 layer={screen_layer} pattern="** screen_layer" text="Надписи" plashka;

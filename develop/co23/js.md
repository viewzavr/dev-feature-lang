...
1. Описать реакцию на то или иное событие. Вообще реакции на события это оказалось на практике основная часть описания процессов. Даже если присмотреться к viewzavr - основной код любых объектов это `env.trackParam(name, reaction_code )`.
2. Описать преобразование данных. 

...
feature "the_view" 
{
  ...
  gui={ 
    ...
    | arr_filter me=@tv code="(val) => val != env.params.me"  
    | repeater //target_parent=@qoco 
    {
...
{
  tv: the-view show_view={ show_visual_tab_row input=@tv; } title="Ряд"
        exporting_2d
   ...
   svt: dom_group 
   {
        ...
        justify-content: center;" 
    {
      repa: repeater input=(@svt->input | geta "sources") {
        src: 
          insert_here list=(@src->input | geta "show_view");
...
feature "show_3d_scene" {
    scene_3d_view: view3d style="position: absolute; top: 0; left: 0; width:100%; height: 100%; z-index:-2"
    {
      r1: render3d 
          ...
          camera3d=(@scene_3d_view->input | geta "camera")
      {

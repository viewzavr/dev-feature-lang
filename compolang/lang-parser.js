...
function peg$parse(input, options) {
  ...
  var peg$e28 = peg$classExpectation([["a", "z"], ["A", "Z"], ["\u0430", "\u044F"], ["\u0410", "\u042F"], "_"], false, false);
  var peg$e29 = peg$classExpectation([["a", "z"], ["A", "Z"], ["\u0430", "\u044F"], ["\u0410", "\u042F"], ["0", "9"], "_"], false, false);
  var peg$e30 = peg$classExpectation([".", "/", "~"], false, false);
  var peg$e31 = peg$otherExpectation("environment empty record");
  var peg$e32 = peg$otherExpectation("environment record");
  var peg$e33 = peg$otherExpectation("environment operator record");
  var peg$e34 = peg$otherExpectation("environment positional record");
  var peg$e35 = peg$literalExpectation("|", false);
  var peg$e36 = peg$otherExpectation("environment args list");
  var peg$e37 = peg$otherExpectation("environment list");
  var peg$e38 = peg$literalExpectation(";", false);
  var peg$e39 = peg$otherExpectation("link value");
  ...
  var peg$e49 = peg$otherExpectation("js inline code");
  ...
  var peg$e57 = peg$classExpectation(["e", "E"], false, false);
  ...
  var peg$f22 = function(envid, env_modifiers, child_envs) {
  ...
  */    
  ...
  var peg$f23 = function(envid, first_feature_name, env_modifiers, child_envs) {
    var env = new_env( envid );
    env.locinfo = getlocinfo();
  ...
  var peg$f24 = function(envid, first_positional_attr, env_modifiers, child_envs) {
    var env = new_env( envid );
    env.locinfo = getlocinfo();
  ...
  var peg$f25 = function(envid, first_positional_attr) {
  ...
  var peg$f26 = function(pipeid, input_link, tail) {
...
*/
  ...
  var peg$f28 = function(attrs) { return { attrs: attrs }
  };
  var peg$f29 = function(args, head, tail) {
  ...
  var peg$f37 = function(env_list) {
    return { param_value_env_list: env_list || [] }
  };
  var peg$f38 = function(env_list) {
    // attr expression
    if (env_list.length > 1) {
  ...
  var peg$f42 = function(attr_name) { return "..."+attr_name };
  var peg$f43 = function(mkeval, attrs, chars) {
  ...
  var peg$f44 = function(mkeval, chars) {
    let code = chars.map(c=>c[1]).join("");
    var env = new_env( "n_func" );
    env.name_is_autogenerated = true;
    env.features["n_func"] = true;
  ...
  var peg$f47 = function(members) { return members !== null ? members: {}; };
  var peg$f48 = function(name, value) {
      return { name: name, value: value };
    };
  var peg$f49 = function(head, tail) { return [head].concat(tail); };
  var peg$f50 = function(values) { return values !== null ? values : []; };
  var peg$f51 = function() { return parseFloat(text()); };
  ...
  var peg$f56 = function() { return "\b"; };
  var peg$f57 = function() { return "\f"; };
  ...
  var peg$f69 = function(sequence) { return sequence; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parsejs_inline_attr_modifier() {
    var s0, s1, s2;
  ...
  function peg$parsejs_inline() {
    ...
    if (s2 !== peg$FAILED) {
      ...
      s7 = peg$parse__();
      s8 = peg$parsejs_inline_attr_modifier();
      if (s8 !== peg$FAILED) {
        s9 = peg$parse__();
        s4 = s8;
      } else {
  ...
  function peg$parsejs_inline_old() {
    var s0, s1, s2, s3, s4, s5;

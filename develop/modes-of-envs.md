...
# PSPS
По поводу пайпов вида @var | a | b - принято такое решение. Их слишком много уже в кодах, всем read не поставишь.
Поэтому - разрешаем им быть но только если они первые в списке выражений, типа some=(@alfa | a | b)
А в других случаях запрещаем. F-WARN-PIPE

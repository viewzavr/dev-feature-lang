...
// здесь мы используем старую версию three-js из-за Loader..
// todo можно перейти на обновленный VTKLoader и тогда заюзать идующий в поставке threejs

//} from '../../../three.js/build/three.module.js';

// ну это наверное неправильно таки.. ссылки туда, сюда..
// впрочем неясно, как это на текущем этапе разруливать без import-maps..
// но можно попробовать что-то придумать, например через setup какой-то с подрузкой верных фич..

...
mainscreen: screen auto-activate padding="1em" {
  ...
  column gap="0.5em" padding="0em" style="z-index: 3; position:absolute;"{
    text text="Укажите файл в параметре csv_file" style="color:red" visible=@file_missing->output;
    file_missing: compute_output input=@pq->output code=`return !env.params.input;`;

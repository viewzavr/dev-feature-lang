...
// либо, рассмотреть вариант без имени тоже хотя вроде бы он и не нужен.
let foo = (func {: ... :})
```
...
назовем эту тему F-JS-FUNC. Хотя они конечно не функции, а вычисления на базе js. Так что формально это jscalc, jscompute, js-comp

...
feature "zal" {
    p: visual_process title="Визуализация зала" 
    {
      ...
      /* я думал сделать radiation и траекторию некими типами данных
         но там хитрый формат данных у ребят в тексте, т.о. не стандартный
         то ли вводить его в стандарты, то ли говорить - мы берем текст
         а тут уже разберемся локально */
